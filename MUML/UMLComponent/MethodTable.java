	...
	private JPopupMenu createToolMenu() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MethodTable.this.clearSelection();
				attributeModel.addRow("+",
						"Method" + MethodTable.this.getRowCount());
				updateUI();
			}
		});
		...
		btnDel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int delIdx;
				delIdx = MethodTable.this.getSelectedRow();
				if (delIdx < 0)
					return;
				MethodTable.this.attributeModel.removeRow(delIdx);
				MethodTable.this.clearSelection();
				updateUI();
			}
		});
		...
		btnPublic.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (MethodTable.this.getSelectedRow() >= 0) {
					int rowIdx = MethodTable.this.getSelectedRow();
		...
		btnUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (MethodTable.this.getSelectedRow() > 0) {
					...
					MethodTable.this.setRowSelectionInterval(rowIdx - 1,
							rowIdx - 1);
				}
				updateUI();
			}
		...
		btnDown.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (MethodTable.this.getSelectedRow() < MethodTable.this
						.getRowCount() - 1) {
					int rowIdx = MethodTable.this.getSelectedRow();
					if (rowIdx >= 0) {
						Object obj0, obj1;
