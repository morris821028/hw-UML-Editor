...
public class OvalButton extends JButton {
	...
	public static void main(String args[]) {
		...
		OvalButton standardButton = new OvalButton("Standard Button");
	...
	public JPanel getButtonsPanel() {
		...
		OvalButton rollOverButton = new OvalButton("RollOver Button");
		rollOverButton.setPreferredSize(new Dimension(130, 28));

		OvalButton disabledButton = new OvalButton("Disable Button");
		disabledButton.setPreferredSize(new Dimension(130, 28));
		disabledButton.setEnabled(false);

		OvalButton pressedButton = new OvalButton("Pressed Button");
